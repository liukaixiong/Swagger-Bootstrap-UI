...
(function ($) {
    ...
    DApiUI.createApiInfoTable = function (apiInfo) {
        ...
        table.append(thead);
        var tbody = $('<tbody></tbody>');
        var projectPath = window.location.href.split("/doc.html")[0] + DApiUI.getStringValue(apiInfo.url);
        ...
        if (typeof (apiInfo.parameters) != 'undefined' && apiInfo.parameters != null) {
            ...
            apiInfo.parameters.forEach(function (param, i) {
                var apiObject = apiInfo;
     ...
     * @param url
     */
    DApiUI.isListContain = function (list, url) {
        var flag = false;
        console.log("-------------------" + list + "---------" + url);
        if (typeof (list) == "undefined") {
            // console.log("----------参数错误!---------" + typeof (list));
            return flag;
        }
        // console.log("-------------------开始遍历---------------------");
